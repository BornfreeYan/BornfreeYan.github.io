...
const socialLinks = [
  ...
  },
  {
    ...
    icon: () => (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
        <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm4.615 14.923h-1.538v-3.077h-1.539v3.077h-3.076v-1.538h1.538v-1.539h-3.077V12.77h1.539v-1.538H8.923V9.693h1.538V8.154h1.539v1.539h1.538V8.154h1.539v1.539h1.538v1.539h-1.538v1.538h1.538v1.539h-1.538v1.538h1.538v1.539z" />
      </svg>
    ),
  },
  {
    name: 'Email',
    href: 'mailto:bornfree@example.com',
    icon: Mail,
  },
  {
    name: 'RSS',
