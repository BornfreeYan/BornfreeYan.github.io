    ...
    <section className="relative overflow-hidden min-h-[80vh] md:min-h-[85vh]">
      ...
      <div className="absolute inset-0 -translate-y-6 md:-translate-y-8">
        ...
        <div className="absolute inset-0 pointer-events-none select-none" aria-hidden>
          {/* 巨型衬线水印：斜体 + 倾斜 30°，与正文格言区分 */}
          <span className="absolute -left-[3%] bottom-[4%] whitespace-nowrap font-heading font-semibold italic leading-none tracking-tight text-accent/[0.09] dark:text-accent-dark/[0.08] text-[clamp(4.5rem,17vw,17rem)] skew-x-[-30deg]">
            Born&nbsp;Free.
          </span>
